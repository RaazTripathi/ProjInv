...
<div class="col-md-9">
                        <div class="catagory-main-box top-radius">
                            <div class="cat-box-title cat-title-font top-radius">Add Borrow </div>

                            <div class="row tb-margin">
                                <div class="col-sm-2"></div>
                            <form action="addborrow.html" method="post" >
                               
                                <div class="col-sm-8 visible-lg visible-md visible-sm">

                                    <div class="form-group">
                                        <label class="col-sm-4 col-xs-12 control-label search-text">Asset Name</label>
                                        <div class="col-sm-8 col-xs-12">
                                          
                                          <form:select class="form-control" path="borrow.employee.id">
                                                    <form:option value=""><spring:message code="label.employee.category.placeholder" text="Default Text"/></form:option>
                                                    <form:options items="${emplist}" itemLabel="firstName" itemValue="id"/>
                                                </form:select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8 col-xs-12">
                                           <input  type="text" class="form-control" name="amount" path="amount" placeholder="Price"/>
                                                                          
                                        </div>
                                    </div>

 <div class="form-group">
                                        <label class="col-sm-4 col-xs-12 control-label search-text"> Remark</label>
                                        <div class="col-sm-8 col-xs-12">
                                           <input  type="text" class="form-control" name="purpose" path="purpose" placeholder="Remark"/>
