	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="catagory-main-box top-radius">
					<div class="cat-box-title cat-title-font top-radius">Debit
						List</div>
...
<span style="font-size: 20px">  Saved Credit Receipts  </span>
	...
	<div class="dialog" title="Create recept">
		...
		<form id="myfrm" action="updateapprove.html">
			...
			<input type="hidden" name="id" value="" id="hiddenid"> <input
				type="hidden" name="level" value="1" id="hiddenid"> <input
