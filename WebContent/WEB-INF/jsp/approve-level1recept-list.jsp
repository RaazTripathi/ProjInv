...
<table id="dttable" class="table table-bordered table-striped"
								...
								<tbody>
									<c:forEach var="jn" items="${journal}">
										...
										<td><c:choose>
												<c:when test="${jn.apelevel2==1}">
              Approved by manager of account
            </c:when>
												<c:otherwise>
  Approved by creater 
												</c:otherwise>
...
<th data-hide="phone">Remark</th>
								...
								<tbody>
									<c:forEach var="jn" items="${ctrl}">
										...
										<c:choose>
											<c:when test="${jn.approvelevel1==1}">
												<tr class="colorow">
											</c:when>
											<c:otherwise>
												<tr class="roclick">
...
$(function() {
	...
	var a = $(".rowclick").find('.aprovehid').val();
	/*  alert(a);
	   if(a==1)
	   	{
	...
	<div class="dialog" title="Create recept">
		...
		<form id="myfrm" action="updateapprove.html">

			<input type="hidden" name="id" value="" id="hiddenid"> <input
				type="hidden" name="level" value="2" id=""> <input
...
<!-- <div class="dialog2" title="Approve Transfer">
		...
		<form id="myfrm2" action="approvetransfer.html">

			<input type="hidden" name="id" value="" id="hiddenid"> <input
				type="hidden" name="level" value="1" id=""> <input
				type="button" value="Approve" class="btn btn-orange"
				id="submitrecptform2">
