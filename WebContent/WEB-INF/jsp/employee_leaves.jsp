    ...
    <body role="document">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        <div class="cat-box-title cat-title-font top-radius">${status}</div>
                            <table class="tab-pane active" id="employee_detailed_information">
                              <tr>
                                ...
                                <label class="col-sm-12 col-xs-12">
                                    <spring:message code="label.leaves.applicable" text="Label value is missing !!!"/>
	                            </label>
	                            </td>
	                            </tr>
	                            <c:forEach var="leave" items="${leaveTypes}">
		                            <tr>
		                            <td>
	                                <label class="col-sm-4 col-xs-12">
	                                    ${leave.name}
