                ...
                <div class="col-md-9">
                    <div class="catagory-main-box top-radius">
                        ...
                        <div class="row tb-margin">
                                        <div class="col-sm-4">
                                            <a href="addborrow.html" class="btn btn-info add-row addrow-btn-left">Add borrow</a>
                                        </div>
                                ...
                                <table id="dttable" class="table table-bordered table-striped" data-filter="#filter" data-page-size="5">
                                    <thead class="orange-bg border-t">
                                        <tr>
                                            ...
                                            <th data-hide="phone">
                                                <spring:message code="label.borro.price" text="Label value is missing !!!"/> 
                                            </th>
                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <c:forEach var="bro" items="${borrow}">
                                            <tr>
                                                <td>${bro.id}</td>
                                                <td>${bro.employee.firstName}</td>
