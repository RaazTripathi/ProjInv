...
/* 15: */{
		...
		if (u != null) {
			if (u.getPassword().equals(
				...
				Collection authorities = new ArrayList(
						buildRolesFromUser(authentication.getName()));
				authorities.addAll(getActivatedModulesAsRoles());
				return new UsernamePasswordAuthenticationToken(u.getName(),
				...
				activatedModules.add(new SimpleGrantedAuthority(
						"ROLE_ANONIMOUS"));
	...
	/* 40: */{
		/* 41:49 */return UsernamePasswordAuthenticationToken.class
