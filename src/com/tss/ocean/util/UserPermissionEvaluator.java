...
/* 16: */{
	...
	/* 17:27 */private static final Logger logger = Logger
			.getLogger(UserPermissionEvaluator.class.getName());
	/* 18: */@Autowired
	...
	/* 24: */
	/* 25: */public boolean hasPermission(Authentication authentication,
	...
	/* 26: */{
		...
		/* 30:43 */if (targetDomainObject == null) {
			/* 31:44 */return false;
			/* 32: */}
		/* 33:46 */if ((authentication == null)
				|| (authentication.getPrincipal() == null)) {
			/* 34:47 */return false;
			/* 35: */}
		/* 36:49 */logger.log(Level.SEVERE, " Asking permission {0} {1} {2}",
				new Object[] { authentication.getPrincipal().toString(),
						targetDomainObject, permission });
		/* 37:50 */if (!authentication.isAuthenticated()) {
			/* 38:51 */return false;
			/* 39: */}
		/* 40:57 */Employees employee = (Employees) this.employeesDAO
				.getRecordByKeyandValue("username", authentication
		...
		/* 45:62 */if (permission.toString().equalsIgnoreCase("VIEW")) {
			...
			/* 49:68 */} else if (permission.toString().equalsIgnoreCase(
				"UPDATE")) {
			/* 50:69 */aclPermission = Integer.valueOf(3);
			/* 51:71 */} else if (permission.toString().equalsIgnoreCase(
				"DELETE")) {
		...
		/* 54:74 */if (aclPermission == null) {
			/* 55:75 */return false;
			/* 56: */}
		/* 57:77 */return this.aclEntityService.hasACL(employee
				.getEmployeeCategoryId().intValue(), 2, targetDomainObject
				.toString().toLowerCase(), aclPermission.intValue());
		/* 58: */}

	/* 59: */
	/* 60: */public boolean hasPermission(Authentication authentication,
			Serializable targetId, String targetType, Object permission)
	/* 61: */{
		/* 62:81 */logger.log(Level.SEVERE,
				" Asking permission {0} {1} {2} {3}", new Object[] {
						authentication.getPrincipal(), targetId, targetType,
						permission });
		/* 63:82 */return true;
		/* 64: */}
	/* 65: */
