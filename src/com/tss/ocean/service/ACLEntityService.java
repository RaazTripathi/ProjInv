...
/* 13: */{
	...
	/* 16: */
	/* 17: */@Transactional
	/* 18: */public int assignACL(int entityId, int entityType, String aclId,
			int permissionlevel)
	/* 19: */{
		...
		/* 25:34 */aCLEntity.setPermissionLevel(Integer
				.valueOf(permissionlevel));
		/* 26:35 */return ((Integer) this.aclEntityDAO.insert(aCLEntity))
				.intValue();
		/* 27: */}
	...
	/* 31: */{
		/* 32:41 */List<ACLEntity> aclEntityList = this.aclEntityDAO
				.getListByCondition(" WHERE entityid=" + entityId
						+ " AND entitytype=" + entityType + " AND aclId='"
						+ aclId + "'");
	...
	/* 40: */{
		/* 41:50 */List<ACLEntity> aclEntityList = this.aclEntityDAO
				.getListByCondition(" WHERE entityid=" + entityId
	...
	/* 49: */{
		/* 50:59 */List<ACLEntity> aclEntityList = this.aclEntityDAO
				.getListByCondition(" WHERE aclid='" + aclId + "'");
	...
	/* 55: */
	/* 56: */public boolean hasACL(int entityId, int entityType, String aclId,
			int permissionLevel)
	/* 57: */{
		/* 58:67 */int count = this.aclEntityDAO.count(" WHERE entityid="
				+ entityId + " AND entitytype=" + entityType
				+ " AND permissionlevel>=" + permissionLevel + " AND aclid='"
				+ aclId + "'");
