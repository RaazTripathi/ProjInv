...
public abstract interface IACLEntiyService {
	@Transactional
	public abstract int assignACL(int paramInt1, int paramInt2,
			String paramString, int paramInt3);

	@Transactional
	public abstract void revokeACL(int paramInt1, int paramInt2,
			String paramString);
	...
	public abstract boolean hasACL(int paramInt1, int paramInt2,
			String paramString, int paramInt3);
}
