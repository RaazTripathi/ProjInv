...
/* 45: */{
	/* 46: 53 */private static final Logger LOG = LoggerFactory
			.getLogger(PurchaseMenuController.class);
	/* 47: */@Autowired
	...
	/* 66: */throws Exception
	/* 67: */{
		/* 68: 81 */binder.registerCustomEditor(Set.class,
				new CustomCollectionEditor(Set.class)
				/* 69: */{
					/* 70: */protected Object convertElement(Object element)
					/* 71: */{
						/* 72: 84 */String itemId = (String) element;
						/* 73: 85 */return PurchaseMenuController.this.itemDAO
								.getRecordByPrimaryKey(Integer.valueOf(itemId));
						/* 74: */}
					/* 75: */
				});
		/* 76: */}
	...
	/* 80: */public ModelAndView add_purrequisition_get(
	...
	/* 103: */{
		...
		/* 106: */{
			/* 107:119 */List<Purrequisitiondt> list = purrequisition
					.getPurrequisitiondts();
			...
			/* 116:129 */List<PurordApprovers> approverlist = this.purchaseApproversDAO
					.getListByCondition("t where t.level=0");
			/* 117:130 */if ((approverlist != null)
			...
			/* 126: */{
				...
				/* 128:138 */Employees employees = (Employees) this.employeesDAO
			...
			/* 142: */{
				/* 143:153 */LOG.debug(
						"Purrequisition Added Successfully with id={0}",
						Integer.valueOf(insertResult));
				/* 144:154 */model.put("purrequisition", purrequisition);
				/* 145:155 */return new ModelAndView(
						"redirect:edit-purchase_request.html?id="
								+ insertResult).addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"purrequisition.add.success", locale));
				/* 146: */}
			/* 147:158 */LOG.debug(
					"Error occurred inserting purrequisition:{0}",
			...
			/* 151:162 */return new ModelAndView("purchase_request", model)
					.addObject("error", Utilities.getSpringMessage(
							this.messageSource, "purrequisition.add.error",
							locale));
			/* 152: */}
		/* 153:167 */LOG.debug("Purchase_request values are not valid:",
				purrequisition.toString());
	...
	/* 164: */{
		...
		/* 170: */{
			...
			/* 172:186 */purrequisition
					.setPurrequisitiondts(this.purrequisitiondtDAO
							.getListByCondition("t where t.purreqid="
									+ purrequisition.getId()));
			/* 173:187 */mav.getModelMap()
					.put("purrequisition", purrequisition);
			/* 174:188 */mav.getModelMap().put(
					"purrequisitiondts",
					this.purrequisitiondtDAO
							.getListByCondition("t where t.purreqid="
									+ purrequisition.getId()));
			/* 175: */
			/* 176:190 */mav.getModelMap().put("supplierList",
					getSupplierList());
			/* 177:191 */mav.getModelMap().put("itemList",
					this.itemDAO.getList());
			/* 178:192 */mav.getModelMap().put("statusList",
					getStatusList(locale));
			/* 179: */}
		/* 180: */else
		/* 181: */{
			/* 182:195 */mav = new ModelAndView(
					"redirect:purchase_request.html");
			/* 183: */}
	...
	/* 197: */{
		...
		/* 200: */{
			...
			/* 204: */{
				/* 205:217 */LOG.debug(
						"purchase_request updated Successfully with id={0}",
						Integer.valueOf(updateResult));
				/* 206:218 */return new ModelAndView(
						"redirect:edit-purchase_request.html").addObject(
						"success", Utilities.getSpringMessage(
								this.messageSource,
								"purrequisition.update.success", locale));
				/* 207: */}
			/* 208:222 */LOG.debug(
					"Error occurred updating purchase_request:{0}",
					purrequisition.toString());
			...
			/* 212:226 */return new ModelAndView("purchase_request", model)
					.addObject("error", Utilities.getSpringMessage(
							this.messageSource, "purrequisition.update.error",
							locale));
			/* 213: */}
		/* 214:231 */LOG.debug("Purchase_request values are not valid:",
				purrequisition.toString());
	...
	/* 225: */{
		...
		/* 233:251 */if (employees != null) {
			...
			/* 235: */}
		/* 236:255 */HashMap<Integer, String> accountMap = new HashMap(
				accountsList.size());
	...
	/* 260: */{
		...
		/* 262:282 */Purrequisition purrequisition = (Purrequisition) this.purrequisitionDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 263:283 */if (purrequisition != null)
		/* 264: */{
			/* 265:284 */int updateResult = this.purrequisitionDAO
					.delete(purrequisition);
			/* 266:285 */if (updateResult > 0)
			/* 267: */{
				/* 268:286 */LOG.debug(
						"Purrequisition with id {0} deleted successfully",
						purrequisition.getId());
				/* 269:287 */return true;
				/* 270: */}
			/* 271:290 */LOG.debug(
					"Error occurred while deleting purrequisition with id {0}",
					purrequisition.getId());
			/* 272:291 */return false;
			/* 273: */}
		/* 274:294 */LOG.debug("Purrequisition with id {0} is already deleted",
				Integer.valueOf(id));
		/* 275:295 */return true;
		/* 276: */}
	...
	/* 279: */{
		/* 280:299 */return this.accountsDAO
				.getListByFromClause(" FROM Accounts a WHERE a.visible=true and a.type=1");
		/* 281: */}
	...
	/* 284: */{
		...
		/* 286:304 */statusList.put(Integer.valueOf(1), Utilities
				.getSpringMessage(this.messageSource,
						"label.purrequisition.status.created", local));
		/* 287:305 */statusList.put(Integer.valueOf(4), Utilities
				.getSpringMessage(this.messageSource,
						"label.purrequisition.status.approved", local));
		/* 288:306 */statusList.put(Integer.valueOf(2), Utilities
				.getSpringMessage(this.messageSource,
						"label.purrequisition.status.suspended", local));
		/* 289:307 */statusList.put(Integer.valueOf(3), Utilities
				.getSpringMessage(this.messageSource,
						"label.purrequisition.status.placed", local));
		/* 290:308 */return statusList;
		/* 291: */}

	/* 292: */
	/* 293: */private Map<Integer, String> getStatusList(Locale local,
			int purchasereq)
	/* 294: */{
		/* 295:312 */Map<Integer, String> statusList = new HashMap();
		/* 296:313 */statusList.put(Integer.valueOf(1), Utilities
				.getSpringMessage(this.messageSource,
						"label.purrequisition.status.created", local));
		/* 297:314 */statusList.put(Integer.valueOf(4), Utilities
				.getSpringMessage(this.messageSource,
						"label.purrequisition.status.approved", local));
		/* 298:315 */statusList.put(Integer.valueOf(2), Utilities
				.getSpringMessage(this.messageSource,
						"label.purrequisition.status.suspended", local));
	...
	/* 303: */@ResponseBody
	/* 304: */public String add_itemdummy(@RequestParam("item") String item,
			@RequestParam("price") double price, @RequestParam("qty") int qty,
			@RequestParam("purreqid") int purreqid, Map<String, Object> model,
			HttpServletRequest request)
	/* 305: */throws Exception
	/* 306: */{
		/* 307:323 */LOG.debug("add-item called.");
		/* 308:324 */Purrequisition purrequisition = (Purrequisition) this.purrequisitionDAO
				.getRecordByPrimaryKey(Integer.valueOf(purreqid));
		/* 309:325 */int status = 0;
		/* 310:326 */if (purrequisition != null)
		/* 311: */{
			/* 312:327 */Item oitem = (Item) this.itemDAO
					.getRecordByKeyandValue("name", item);
			/* 313:328 */if (oitem != null)
			/* 314: */{
				/* 315:329 */Purrequisitiondt purrequisitiondt = new Purrequisitiondt(
						purreqid, oitem.getId().intValue(), qty, oitem, price);
				/* 316:330 */status = ((Integer) this.purrequisitiondtDAO
						.insert(purrequisitiondt)).intValue();
				/* 317: */}
			/* 318: */else
			/* 319: */{
		...
		/* 325: */{
			/* 326:336 */LOG
					.debug("purchase req is not found for adding item...");
	...
	/* 336: */{
		...
		/* 338:346 */Purrequisitiondt purrequisitiondt = (Purrequisitiondt) this.purrequisitiondtDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 339:347 */int updateResult = 0;
		/* 340:348 */if (purrequisitiondt != null)
		/* 341: */{
			/* 342:349 */updateResult = this.purrequisitiondtDAO
					.delete(purrequisitiondt);
			/* 343:350 */if (updateResult > 0)
			/* 344: */{
				/* 345:351 */LOG.debug(
						"Purrequisition with id {0} deleted successfully",
						purrequisitiondt.getId());
			...
			/* 350: */}
		/* 351:359 */LOG.debug("Purrequisition with id {0} is already deleted",
				Integer.valueOf(id));
	...
	/* 336: */{
		/* 337:345 */LOG.debug("delete_purrequisitiondt called.");
		Purrequisition purrequissition = (Purrequisition) this.purrequisitionDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 339:347 */int updateResult = 0;
