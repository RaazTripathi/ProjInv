...
/* 26: */{
	/* 27: 38 */private static final Logger logger = Logger
	...
	/* 37: */public ModelAndView inventorymgmt(
			@ModelAttribute("itemTypeForm") @Valid Itemtype itemTypeForm,
			BindingResult result, Map<String, Object> model)
	/* 38: */throws Exception
	/* 39: */{
		/* 40: 53 */logger.log(Level.OFF,
				"Add Inventory called with inventory details ####### ."
						+ itemTypeForm);
		/* 41: 55 */if (result.hasErrors())
		/* 42: */{
			/* 43: 56 */logger.log(Level.OFF,
					"Error occured while inserting the reconrd for the item type."
							+ result.getAllErrors());
			/* 44: 57 */ModelAndView modelAndView = new ModelAndView(
					"add-item_category");
			/* 45: */
			/* 46: 59 */modelAndView.addAllObjects(model);
			/* 47: 60 */return modelAndView;
			/* 48: */}
		/* 49: 62 */logger.log(Level.OFF, "Insert result ####### ."
				+ this.itemTypeDAO.insert(itemTypeForm));
	...
	/* 55: */public ModelAndView updateItemCategory(
			@ModelAttribute("itemTypeForm") @Valid Itemtype itemTypeForm,
			BindingResult result, Map<String, Object> model)
	/* 56: */throws Exception
	/* 57: */{
		/* 58: 70 */logger.log(Level.WARNING,
				"Update Inventory called with inventory details ####### ."
						+ itemTypeForm);
		/* 59: 72 */if (result.hasErrors())
		/* 60: */{
			/* 61: 73 */logger.log(Level.OFF,
					"Error occured while inserting the reconrd for the item type."
							+ result.getAllErrors());
			/* 62: 74 */ModelAndView modelAndView = new ModelAndView(
					"add-item_category");
			/* 63: */
			/* 64: 76 */modelAndView.addAllObjects(model);
			/* 65: 77 */return modelAndView;
			/* 66: */}
		/* 67: 79 */Itemtype oldType = (Itemtype) this.itemTypeDAO
				.getRecordByPrimaryKey(itemTypeForm.getId());
		...
		/* 69: */{
			...
			/* 73: 84 */logger.log(Level.OFF, "Insert result ####### ."
					+ status);
			/* 74: */}
	...
	/* 80: */public ModelAndView addItemUnits(
			@ModelAttribute("itemUnit") @Valid Itemunit itemUnit,
			BindingResult result, Map<String, Object> model)
	/* 81: */throws Exception
	/* 82: */{
		/* 83: 93 */logger.log(Level.OFF,
				"Add Item Units with detail ####### ." + itemUnit);
		/* 84: 95 */if (result.hasErrors())
		/* 85: */{
			/* 86: 96 */logger.log(Level.OFF,
					"Error occured while inserting the reconrd for the item unit."
							+ result.getAllErrors());
			/* 87: 97 */ModelAndView modelAndView = new ModelAndView(
					"add-item_unit");
			/* 88: */
		...
		/* 94: */{
			/* 95:104 */status = ((Integer) this.itemunitDAO.insert(itemUnit))
					.intValue();
			/* 96: */}
		/* 97: */else
		/* 98: */{
			/* 99:106 */Itemunit oldItemUnit = (Itemunit) this.itemunitDAO
					.getRecordByPrimaryKey(itemUnit.getId());
			...
			/* 103: */}
		/* 104:111 */logger.log(Level.OFF, "Insert result ####### success."
				+ status);
...
*/		System.out.println(req.getCharacterEncoding()+"KKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKKK");
		...
		/* 114: */{
			...
			/* 117: */{
				/* 118:122 */logger.log(Level.OFF,
						"Error occured while inserting the reconrd for the item."
								+ result.getAllErrors());
				/* 119:123 */ModelAndView modelAndView = new ModelAndView(
						"add-item");
				/* 120: */
				/* 121:125 */model.put("itemUnitList",
		...
		if (result.hasErrors())
		{
			/* 133:138 */logger.log(Level.OFF,
					"Error occured while editing the reconrd for the item."
							+ result.getAllErrors());
			/* 134:139 */ModelAndView modelAndView = new ModelAndView(
					"add-item");
			/* 135: */
			...
			/* 140: */}
		/* 141:146 */Item oldItem = (Item) this.itemDAO
				.getRecordByPrimaryKey(item.getId());
	...
	/* 155: */{
		...
		/* 158: */{
			/* 159:162 */logger.log(Level.OFF,
					"Error occured while editing the reconrd for the item."
							+ result.getAllErrors());
			/* 160:163 */ModelAndView modelAndView = new ModelAndView(
					"add-item");
			/* 161: */
			...
			/* 166: */}
		/* 167:170 */Item oldItem = (Item) this.itemDAO
				.getRecordByPrimaryKey(item.getId());
	...
	/* 179: */public ModelAndView deleteItemCategory(
			@RequestParam("deleteId") int deleteId, Map<String, Object> model)
	/* 180: */throws Exception
	/* 181: */{
		/* 182:183 */logger.log(Level.FINE, "Delete item category called.");
		/* 183:184 */Itemtype itemType = (Itemtype) this.itemTypeDAO
				.getRecordByPrimaryKey(Integer.valueOf(deleteId));
		/* 184:185 */if (itemType != null)
		/* 185: */{
			/* 186:186 */int updateResult = this.itemTypeDAO.delete(itemType);
			/* 187:187 */if (updateResult > 0) {
				/* 188:188 */logger.log(Level.INFO,
						"Item Type with id {0} deleted successfully",
						itemType.getId());
				/* 189: */} else {
				/* 190:190 */logger.log(Level.WARNING,
						"Error occurred while deleting item type with id {0}",
						itemType.getId());
				/* 191: */}
			/* 192: */}
		/* 193:193 */logger.log(Level.INFO,
				"Item Type with id {0} is already deleted",
	...
	/* 199: */public ModelAndView deleteItem(
			@RequestParam("deleteId") int deleteId, Map<String, Object> model)
	/* 200: */throws Exception
	/* 201: */{
		/* 202:200 */logger.log(Level.FINE, "Delete item called.");
		/* 203:201 */Item itemBean = (Item) this.itemDAO
				.getRecordByPrimaryKey(Integer.valueOf(deleteId));
		/* 204:202 */if (itemBean != null)
		/* 205: */{
			/* 206:203 */int updateResult = this.itemDAO.delete(itemBean);
			/* 207:204 */if (updateResult > 0) {
				/* 208:205 */logger.log(Level.INFO,
						"Item id {0} deleted successfully", itemBean.getId());
				/* 209: */} else {
				/* 210:207 */logger.log(Level.WARNING,
						"Error occurred while deleting item with id {0}",
						itemBean.getId());
				/* 211: */}
			/* 212: */}
		/* 213:210 */logger.log(Level.INFO,
				"Item with id {0} is already deleted",
				Integer.valueOf(deleteId));
	...
	/* 219: */public ModelAndView deleteItemUnits(
			@RequestParam("deleteId") int deleteId, Map<String, Object> model)
	/* 220: */throws Exception
	/* 221: */{
		/* 222:217 */logger.log(Level.FINE,
				"Delete item category units called.");
		/* 223:218 */Itemunit itemUnit = (Itemunit) this.itemunitDAO
				.getRecordByPrimaryKey(Integer.valueOf(deleteId));
		/* 224:219 */if (itemUnit != null)
		/* 225: */{
			/* 226:220 */int updateResult = this.itemunitDAO.delete(itemUnit);
			/* 227:221 */if (updateResult > 0) {
				/* 228:222 */logger.log(Level.INFO,
						"Item Units with id {0} deleted successfully",
						itemUnit.getId());
				/* 229: */} else {
				/* 230:224 */logger.log(Level.WARNING,
						"Error occurred while deleting item units with id {0}",
						itemUnit.getId());
				/* 231: */}
			/* 232: */}
		/* 233:227 */logger.log(Level.INFO,
				"Item Units with id {0} is already deleted",
				Integer.valueOf(deleteId));
	...
	/* 239: */public String updateItemUnits(
			@RequestParam("updateItemId") int updateItemId,
			Map<String, Object> model)
	/* 240: */throws Exception
	/* 241: */{
		/* 242:234 */logger.log(Level.OFF, "Update Item Unit called.");
		/* 243:235 */model.put("itemUnit", this.itemunitDAO
				.getRecordByPrimaryKey(Integer.valueOf(updateItemId)));
	...
	/* 249: */public String updateItemCategory(
			@RequestParam("updateItemId") int updateItemId,
			Map<String, Object> model)
	/* 250: */throws Exception
	/* 251: */{
		/* 252:242 */logger.log(Level.OFF, "Update Item Category called.");
		/* 253:243 */model.put("itemTypeForm", this.itemTypeDAO
				.getRecordByPrimaryKey(Integer.valueOf(updateItemId)));
	...
	/* 259: */public String edit_item(
			@RequestParam("updateItemId") int updateItemId,
			Map<String, Object> model, HttpServletRequest request)
	/* 260: */throws Exception
	/* 261: */{
		/* 262:249 */logger.log(Level.OFF, "add-item called.");
		/* 263:250 */model.put("itemForm", this.itemDAO
				.getRecordByPrimaryKey(Integer.valueOf(updateItemId)));
	...
	/* 270: */@ResponseBody
	/* 271: */public String add_itemdummy(@RequestParam("item") String item,
			Map<String, Object> model, HttpServletRequest request)
	...
	/* 283: */@ResponseBody
	/* 284: */public String validate_Itemname(
			@RequestParam("item") String item, Map<String, Object> model,
			HttpServletRequest request)
	/* 285: */throws Exception
	/* 286: */{
		/* 287:268 */logger.log(Level.OFF, "add-item called.");
		/* 288:269 */Item oItem = (Item) this.itemDAO.getRecordByKeyandValue(
				"name", item);
		/* 289:270 */StringBuilder sb = new StringBuilder();
		/* 290:271 */if (oItem == null) {
			/* 291:272 */sb
					.append("{\"code\":\"401\",\"message\":\"Item name is wrong.\"}");
			/* 292: */} else {
			/* 293:274 */sb
					.append("{\"code\":\"200\",\"message\":\"Success\"}");
			/* 294: */}
	...
	/* 43: */public String itemmgmtFindbrcode()
	/* 44: */throws Exception
	/* 45: */{
		...
		/* 49: 57 */return "find-barcode-item";
		/* 50: */}
	...
	/* 40: */
	/* 41: */@RequestMapping(value = { "/findbybarcode.html" }, method = { org.springframework.web.bind.annotation.RequestMethod.POST })
	/* 42: */@PreAuthorize("hasAnyRole('ROLE_USER') ")
	/* 43: */public String itemmgmt(@RequestParam ("barcode") String barcode,Model model, HttpServletRequest request)
	/* 44: */throws Exception
	/* 45: */{
		/* 46: 54 */logger.log(Level.OFF, "item called.");
		/* 47: 55 */logger.log(Level.OFF, "item called size ### "
