...
/* 25: */{
	/* 26: 36 */private static final Logger logger = LoggerFactory
	...
	/* 35: */public ModelAndView updateControlParent(
	...
	/* 37: */{
		...
		/* 39: 52 */ModelAndView mav = new ModelAndView(
				"redirect:/access_control.html");
		/* 40: 53 */updateACL(req);
		/* 41: */
		/* 42: 55 */return mav;
		/* 43: */}
	...
	/* 44: */
	/* 45: */@RequestMapping(value = { "/access_control.html" }, method = {
			org.springframework.web.bind.annotation.RequestMethod.POST,
			org.springframework.web.bind.annotation.RequestMethod.GET })
	/* 46: */public ModelAndView accessControlParent(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			@RequestParam(value = "categoryId", required = false) Integer categoryId,
			Locale locale)
	...
	/* 48: */{
		...
		/* 51: 65 */List<EmployeeCategory> employeeCategoryList = this.employeeCategoryDAO
				.getList();
		/* 52: 66 */logger
				.info("access_control called." + employeeCategoryList);
		/* 53: 67 */mav.getModelMap().put("employeeCategoryList",
				employeeCategoryList);
		/* 54: 69 */if (categoryId != null)
		/* 55: */{
			/* 56: 70 */logger.info("Processing for category " + categoryId);
			/* 57: 71 */List<Object[]> listByHQLQuery = this.aclEntityDAO
					.getListByHQLQuery("select aclEntity.Id,acl.aclModule,aclEntity.aclId,aclEntity.permissionLevel from ACL acl, ACLEntity aclEntity where acl.aclId = aclEntity.aclId and aclEntity.entityType = 2 and aclEntity.entityId = "
							+ categoryId);
			...
			/* 59: 73 */if (listByHQLQuery != null) {
				...
				/* 61: */{
					...
					/* 63: 76 */aCLDetailDTO
							.setAclEntityId(((Number) values[0]).intValue());
					/* 64: 77 */aCLDetailDTO.setAclModule((String) values[1]);
					/* 65: 78 */aCLDetailDTO.setAclId((String) values[2]);
					/* 66: 79 */aCLDetailDTO
							.setPermissionLevel((Integer) values[3]);
					/* 67: 80 */entityWiseACLDetails.add(aCLDetailDTO);
					/* 68: */}
				/* 69: */}
			/* 70: 84 */logger.info("access_control called."
					+ entityWiseACLDetails);
			/* 71: 85 */mav.getModelMap().put("entityWiseACLDetails",
					entityWiseACLDetails);
			/* 72: */
		...
		/* 75: */else
		/* 76: */{
			/* 77: 89 */mav.getModelMap()
					.put("categoryId", Integer.valueOf(-1));
			/* 78: */}
	...
	/* 89: */{
		/* 90:101 */Enumeration<String> parameterNames = req
				.getParameterNames();
		/* 91:102 */while (parameterNames.hasMoreElements())
		/* 92: */{
			/* 93:103 */String paramName = (String) parameterNames
					.nextElement();
			/* 94:104 */ACLEntity aCLEntity = (ACLEntity) this.aclEntityDAO
					.getRecordByPrimaryKey(Integer.valueOf(paramName));
			/* 95:105 */String[] paramValues = req
					.getParameterValues(paramName);
			/* 96:106 */for (int i = 0; i < paramValues.length; i++)
			/* 97: */{
				/* 98:107 */String paramValue = paramValues[i];
				/* 99:108 */aCLEntity.setPermissionLevel(Integer
						.valueOf(paramValue));
				/* 100: */}
