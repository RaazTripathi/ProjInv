...
public class InvoiceController {
	...
	public ModelAndView invoiceEntryDisplay(String flashMessage)
			throws Exception {
		...
		try {
			...
			logger.error("Error in fetching items for the invoice: "
					+ e.getMessage());
	...
	public ModelAndView saveInvoiceData(
	...
	public ModelAndView listCashCollections(
	...
	public ModelAndView listBankCollections(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale) throws Exception {
		logger.info("Starting the save of data.");
	...
	public ModelAndView listBankCollectionsOnFinanceMenu(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale) throws Exception {
		logger.info("Starting the save of data.");
	...
	public ModelAndView invoiceEditDisplay(@RequestParam("id") int id,
			Locale locale,
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error)
			throws Exception {
	...
	public ModelAndView updateInvoiceData(
			@ModelAttribute("invoice") @Valid Invoice invoice,
			BindingResult result, ModelMap model, Locale locale)
			throws Exception {
