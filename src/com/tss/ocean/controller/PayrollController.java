...
/* 37: */{
	/* 38: 47 */private static final Logger LOGGER = LoggerFactory
			.getLogger(PayrollController.class);
	/* 39: */@Autowired
	...
	/* 49: */public ModelAndView employeeCategory(
	...
	/* 51: */{
		...
		/* 54: 65 */List<PayrollCategories> payrollcategoryList = this.payrollCategoriesDAO
				.getList();
		/* 55: 66 */HashMap<Integer, String> payrollCategorymap = new HashMap(
				payrollcategoryList.size());
		/* 56: 67 */for (PayrollCategories payrollCategories : payrollcategoryList) {
			/* 57: 68 */payrollCategorymap.put(payrollCategories.getId(),
					payrollCategories.getName());
			/* 58: */}
		/* 59: 70 */mav.getModelMap().put("payrollCategoryList",
				payrollcategoryList);
		/* 60: 71 */mav.getModelMap().put("payrollCategorymap",
				payrollCategorymap);
	...
	/* 71: */public ModelAndView addpayrollCategoryGet(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	/* 72: */throws Exception
	/* 73: */{
		...
		/* 80: 91 */if (error != null) {
			...
			/* 82: */}
		/* 83: 94 */List<PayrollCategories> payrollcategoryList = this.payrollCategoriesDAO
				.getList();
		/* 84: 95 */mav.getModelMap().put("payrollCategoryList",
				payrollcategoryList);
	...
	/* 90: */public ModelAndView addPayrollCategoryPost(
			@ModelAttribute("payrollcategory") @Valid PayrollCategories payrollCategories,
	...
	/* 92: */{
		...
		/* 95: */{
			/* 96:107 */int insertResult = ((Integer) this.payrollCategoriesDAO
					.insert(payrollCategories)).intValue();
			/* 97:108 */if (insertResult > 0)
			/* 98: */{
				/* 99:109 */LOGGER
						.info("Payroll category Added Successfully with id "
								+ insertResult);
				/* 100:110 */return new ModelAndView(
						"redirect:add_payroll_category.html").addObject(
						"success", Utilities.getSpringMessage(
								this.messageSource,
								"payrollcategory.add.success", locale));
				/* 101: */}
			/* 102:113 */LOGGER.info("Error while inserting "
					+ payrollCategories);
			/* 103:114 */return new ModelAndView("add_payroll_category", model)
					.addObject("error", Utilities.getSpringMessage(
							this.messageSource, "payrollcategory.add.error",
							locale));
			/* 104: */}
	...
	/* 109: */public ModelAndView editPayrollCategoryGet(
	...
	/* 111: */{
		...
		/* 113: */
		/* 114:130 */PayrollCategories payrollCategories = (PayrollCategories) this.payrollCategoriesDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 115:131 */List<PayrollCategories> payrollcategoryList = this.payrollCategoriesDAO
				.getList();
		/* 116: */ModelAndView mav;
		/* 117:132 */if (payrollCategories != null)
		/* 118: */{
			/* 119:133 */mav = new ModelAndView("edit_payroll_category");
			/* 120:134 */mav.getModelMap().put("payrollCategoryList",
					payrollcategoryList);
			/* 121:135 */mav.getModelMap().put("payrollcategory",
					payrollCategories);
			/* 122: */}
		/* 123: */else
		/* 124: */{
			/* 125:137 */mav = new ModelAndView(
					"redirect:payroll_category.html");
			/* 126:138 */HashMap<Integer, String> payrollCategorymap = new HashMap(
					payrollcategoryList.size());
			/* 127:139 */for (PayrollCategories payrollCategories1 : payrollcategoryList) {
				/* 128:140 */payrollCategorymap.put(payrollCategories1.getId(),
						payrollCategories1.getName());
				/* 129: */}
			/* 130:142 */mav.getModelMap().put("payrollCategoryList",
					payrollcategoryList);
			/* 131:143 */mav.getModelMap().put("payrollCategorymap",
					payrollCategorymap);
			/* 132: */}
	...
	/* 143: */public ModelAndView editPayrollCategoryPost(
			@ModelAttribute("payrollcategory") @Valid PayrollCategories payrollCategories,
			BindingResult result, ModelMap model, Locale locale)
	/* 144: */throws Exception
	/* 145: */{
		/* 146:159 */LOGGER.info("edit_payroll_category-post called.");
		/* 147:160 */List<PayrollCategories> payrollcategoryList = this.payrollCategoriesDAO
				.getList();
		/* 148:161 */if (!result.hasErrors())
		/* 149: */{
			/* 150:162 */int updateResult = this.payrollCategoriesDAO
					.update(payrollCategories);
			/* 151:163 */if (updateResult > 0)
			/* 152: */{
				/* 153:164 */LOGGER.info(
						"payroll_category updated Successfully with id={0}",
						Integer.valueOf(updateResult));
				/* 154:165 */ModelAndView mav = new ModelAndView(
						"redirect:payroll_category.html");
				/* 155:166 */HashMap<Integer, String> payrollCategorymap = new HashMap(
						payrollcategoryList.size());
				/* 156:167 */for (PayrollCategories payrollCategories1 : payrollcategoryList) {
					/* 157:168 */payrollCategorymap.put(
							payrollCategories1.getId(),
							payrollCategories1.getName());
					/* 158: */}
				/* 159:170 */mav.getModelMap().put("payrollCategoryList",
						payrollcategoryList);
				/* 160:171 */mav.getModelMap().put("payrollCategorymap",
						payrollCategorymap);
				/* 161:172 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"payrollcategory.update.success", locale));
				/* 162: */}
			/* 163:175 */LOGGER.warn(
					"Error occurred updating payroll category:{0}",
					payrollCategories);
			/* 164:176 */return new ModelAndView("edit_payroll_category", model)
					.addObject("error", Utilities.getSpringMessage(
							this.messageSource, "payrollcategory.update.error",
							locale));
			/* 165: */}
		/* 166:180 */LOGGER.warn("Employee department values are not valid:",
				payrollCategories);
	...
	/* 171: */@ResponseBody
	/* 172: */public ModelAndView deletePayrollCategory(
			@RequestParam("id") int id, Locale locale)
	/* 173: */throws Exception
	/* 174: */{
		/* 175:188 */LOGGER.info("delete_payroll_category called.");
		/* 176:189 */PayrollCategories payrollCategories = (PayrollCategories) this.payrollCategoriesDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 177:190 */ModelAndView mav = new ModelAndView(
				"redirect:payroll_category.html");
		/* 178:191 */List<PayrollCategories> payrollcategoryList = this.payrollCategoriesDAO
				.getList();
		/* 179:192 */HashMap<Integer, String> payrollCategorymap = new HashMap(
				payrollcategoryList.size());
		/* 180:193 */for (PayrollCategories payrollCategories1 : payrollcategoryList) {
			/* 181:194 */payrollCategorymap.put(payrollCategories1.getId(),
					payrollCategories1.getName());
			/* 182: */}
		/* 183:196 */mav.getModelMap().put("payrollCategoryList",
				payrollcategoryList);
		/* 184:197 */mav.getModelMap().put("payrollCategorymap",
				payrollCategorymap);
		/* 185:198 */if (payrollCategories != null)
		/* 186: */{
			/* 187:199 */int updateResult = this.payrollCategoriesDAO
					.delete(payrollCategories);
			/* 188:201 */if (updateResult > 0)
			/* 189: */{
				/* 190:202 */LOGGER.info(
						"Payroll Category with id {0} deleted successfully",
						payrollCategories.getId());
				/* 191: */
				/* 192:204 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"payrollcategory.delete.success", locale));
				/* 193: */}
			/* 194:207 */LOGGER
					.warn("Error occurred while deleting employee department with id {0}",
							payrollCategories.getId());
			/* 195:208 */return mav.addObject("error", Utilities
					.getSpringMessage(this.messageSource,
							"payrollcategory.delete.error", locale));
			/* 196: */}
		/* 197:212 */LOGGER.info(
				"Payroll Department with id {0} is already deleted",
				payrollCategories.getId());
		/* 198:213 */return mav.addObject("success", Utilities
				.getSpringMessage(this.messageSource,
						"payrollcategory.delete.error", locale));
		/* 199: */}
	...
	/* 202: */public ModelAndView payslip(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	...
	/* 204: */{
		...
		/* 211:227 */List<PayrollCategories> payrollCategoryList = this.payrollCategoriesDAO
				.getList();
		/* 212:228 */mav.getModelMap().put("employeeList", employeeList);
		/* 213:229 */mav.getModelMap()
				.put("payslipContainer", payslipContainer);
		/* 214:230 */mav.getModelMap().put("payrollcategoryList",
				payrollCategoryList);
	...
	/* 225: */public ModelAndView createPayslip(
			@ModelAttribute("payslipContainer") @Valid PayslipContainer payslipContainer,
			BindingResult result, ModelMap model, Locale locale)
	/* 226: */throws Exception
	/* 227: */{
		/* 228:245 */LOGGER.info("create_payslip post called."
				+ payslipContainer.getMonthlyPayslipList());
		...
		/* 235:252 */List<PayrollCategories> payrollCategoryList = this.payrollCategoriesDAO
				.getList();
		/* 236:253 */mav.getModelMap().put("employeeList", employeeList);
		/* 237:254 */mav.getModelMap().put("payslipContainer",
				payslipContainerNew);
		/* 238:255 */mav.getModelMap().put("payrollcategoryList",
				payrollCategoryList);
		/* 239:256 */if (!result.hasErrors())
		/* 240: */{
			/* 241:258 */if (!isPayslipCreated(
					payslipContainer.getEmployeeId(),
					payslipContainer.getSalaryDate()))
			/* 242: */{
				/* 243:259 */int insertResult = 0;
				/* 244:260 */List<MonthlyPayslips> monthlyPayslipList = payslipContainer
						.getMonthlyPayslipList();
				/* 245:261 */if ((monthlyPayslipList != null)
						&& (!monthlyPayslipList.isEmpty())) {
					/* 246:262 */for (MonthlyPayslips monthlyPayslips1 : payslipContainer
							.getMonthlyPayslipList())
					/* 247: */{
						/* 248:263 */monthlyPayslips1
								.setEmployeeId(payslipContainer.getEmployeeId());
						/* 249:264 */monthlyPayslips1
								.setSalaryDate(payslipContainer.getSalaryDate());
						/* 250:265 */monthlyPayslips1.setIsApproved(false);
						/* 251:266 */monthlyPayslips1.setIsRejected(false);
						/* 252:267 */insertResult = ((Integer) this.monthlyPayslipsDAO
								.insert(monthlyPayslips1)).intValue();
						/* 253: */}
					/* 254: */}
				/* 255:271 */if (insertResult > 0)
				/* 256: */{
					/* 257:272 */LOGGER.info("Payslips created");
					/* 258:273 */return mav.addObject("success", Utilities
							.getSpringMessage(this.messageSource,
									"payslip.add.success", locale));
					/* 259: */}
				/* 260:276 */LOGGER.info("Error while inserting ");
				/* 261:277 */return mav.addObject("error", Utilities
						.getSpringMessage(this.messageSource,
								"payslip.add.error", locale));
				/* 262: */}
			...
			/* 266:284 */return mav
					.addObject(
							"error",
							"Payslip is created for employee for month "
									+ calendar.getDisplayName(2, 2,
											Locale.getDefault()));
			/* 267: */}
	...
	/* 270: */
	/* 271: */private List<MonthlyPayslips> getMonthlyPayslipByEmployee(
			Integer employeeId)
	/* 272: */{
		/* 273:294 */return this.monthlyPayslipsDAO
				.getListByFromClause(" FROM MonthlyPayslips m WHERE m.employeeId="
						+ employeeId);
		/* 274: */}

	/* 275: */
	/* 276: */private boolean isPayslipCreated(Integer employeeId,
			Date createDate)
	/* 277: */{
		...
		/* 282:302 */if ((monthlyPayslipsList != null)
				&& (!monthlyPayslipsList.isEmpty())) {
			/* 283:303 */for (MonthlyPayslips monthlyPayslips : monthlyPayslipsList)
			/* 284: */{
				/* 285:304 */salarycal.setTime(monthlyPayslips.getSalaryDate());
				/* 286:305 */if ((createdatecal.get(2) == salarycal.get(2))
						&& (createdatecal.get(1) == salarycal.get(1))) {
					/* 287:306 */return true;
					/* 288: */}
				/* 289: */}
			/* 290: */}
	...
	/* 295: */public ModelAndView getPayslipList(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	...
	/* 310: */public ModelAndView getPayslipList(HttpServletRequest request,
	...
	/* 312: */{
		...
		/* 318: */{
			/* 319:340 */List<MonthlyPayslips> payslips = getMonthlyPayslipsForMonthYear(
					Integer.valueOf(month).intValue(), Integer.valueOf(year)
							.intValue());
			...
			/* 322: */{
				/* 323:343 */for (MonthlyPayslips monthlyPayslips : payslips) {
					/* 324:344 */if (payslipMap.containsKey(monthlyPayslips
							.getEmployeeId()))
					/* 325: */{
						/* 326:345 */Payslip payslip = (Payslip) payslipMap
								.get(monthlyPayslips.getEmployeeId());
						/* 327:346 */PayrollCategories payrollCategories = (PayrollCategories) this.payrollCategoriesDAO
								.getRecordByPrimaryKey(monthlyPayslips
										.getPayrollCategoryId());
						/* 328:347 */if (payrollCategories.getIsDeduction()
								.booleanValue())
						/* 329: */{
							/* 330:348 */payslip.setDeductions(Double
									.valueOf(payslip.getDeductions()
											.doubleValue()
											+ monthlyPayslips.getAmount()
													.doubleValue()));
							/* 331:349 */payslip.setTotal(Double
									.valueOf(payslip.getTotal().doubleValue()
											- monthlyPayslips.getAmount()
													.doubleValue()));
							/* 332:350 */payslip.getDeductionList().add(
									monthlyPayslips);
							/* 333: */}
						/* 334: */else
						/* 335: */{
							/* 336:352 */payslip.setSalary(Double
									.valueOf(payslip.getSalary().doubleValue()
											+ monthlyPayslips.getAmount()
													.doubleValue()));
							/* 337:353 */payslip.setTotal(Double
									.valueOf(payslip.getTotal().doubleValue()
											+ monthlyPayslips.getAmount()
													.doubleValue()));
							/* 338:354 */payslip.getSalaryList().add(
									monthlyPayslips);
							/* 339: */}
						/* 340: */}
					/* 341: */else
					/* 342: */{
						...
						/* 344:359 */Employees employee = (Employees) this.employeesDAO
								.getRecordByPrimaryKey(monthlyPayslips
										.getEmployeeId());
						/* 345:360 */payslip.setEmployeeId(monthlyPayslips
								.getEmployeeId());
						/* 346:361 */if (employee != null)
						/* 347: */{
							/* 348:362 */payslip.setEmployeeNumber(employee
									.getEmployeeNumber());
							/* 349:363 */payslip.setFirstName(employee
									.getFirstName());
							/* 350:364 */payslip.setLastName(employee
									.getLastName());
							/* 351: */}
						/* 352:366 */payslip.setSalary(Double.valueOf(0.0D));
						/* 353:367 */payslip
								.setDeductions(Double.valueOf(0.0D));
						/* 354:368 */payslip.setTotal(Double.valueOf(0.0D));
						/* 355:369 */PayrollCategories payrollCategories = (PayrollCategories) this.payrollCategoriesDAO
								.getRecordByPrimaryKey(monthlyPayslips
										.getPayrollCategoryId());
						/* 356:371 */if (payrollCategories.getIsDeduction()
								.booleanValue())
						/* 357: */{
							/* 358:372 */payslip.setDeductions(Double
									.valueOf(payslip.getDeductions()
											.doubleValue()
											+ monthlyPayslips.getAmount()
													.doubleValue()));
							/* 359:373 */payslip.setTotal(Double
									.valueOf(payslip.getTotal().doubleValue()
											- monthlyPayslips.getAmount()
													.doubleValue()));
							/* 360:374 */payslip
									.setDeductionList(new ArrayList());
							/* 361:375 */payslip.getDeductionList().add(
									monthlyPayslips);
							/* 362: */}
						/* 363: */else
						/* 364: */{
							/* 365:377 */payslip.setSalary(Double
									.valueOf(payslip.getSalary().doubleValue()
											+ monthlyPayslips.getAmount()
													.doubleValue()));
							/* 366:378 */payslip.setTotal(Double
									.valueOf(payslip.getTotal().doubleValue()
											+ monthlyPayslips.getAmount()
													.doubleValue()));
							/* 367:379 */payslip.setSalaryList(new ArrayList());
							/* 368:380 */payslip.getSalaryList().add(
									monthlyPayslips);
							/* 369: */}
						/* 370:383 */payslipMap.put(
								monthlyPayslips.getEmployeeId(), payslip);
						/* 371:384 */employeeList.add(monthlyPayslips
								.getEmployeeId());
						/* 372: */}
					/* 373: */}
				/* 374:388 */mav.getModelMap()
						.put("employeeList", employeeList);
				/* 375:389 */mav.getModelMap().put("payslipmap", payslipMap);
				/* 376:390 */request.getSession().setAttribute("payslipmap",
						payslipMap);
				/* 377: */}
			/* 378: */}
	...
	/* 387: */
	/* 388: */List<MonthlyPayslips> getMonthlyPayslipsForMonthYear(int month,
			int year)
	/* 389: */{
		/* 390:405 */List<MonthlyPayslips> list = this.monthlyPayslipsDAO
				.getList();
	...
	/* 410: */public ModelAndView getDetailedPayslip(
	...
	/* 412: */{
		...
		/* 416:433 */List<PayrollCategories> payrollCategorieses = this.payrollCategoriesDAO
				.getList();
		/* 417:434 */Map<Integer, String> payrollCategoryMap = new HashMap();
		/* 418:435 */if ((payrollCategorieses != null)
				&& (!payrollCategorieses.isEmpty())) {
			/* 419:436 */for (PayrollCategories payrollCategories : payrollCategorieses) {
				/* 420:437 */payrollCategoryMap.put(payrollCategories.getId(),
						payrollCategories.getName());
				/* 421: */}
			/* 422: */}
		/* 423:441 */HashMap<Integer, Payslip> payslipMap = (HashMap) request
				.getSession().getAttribute("payslipmap");
		...
		/* 427: */{
			...
			/* 432: */{
				/* 433:449 */if (payslip.getSalaryList() != null) {
					/* 434:450 */for (MonthlyPayslips monthlyPayslips1 : payslip
							.getSalaryList()) {
						/* 435:451 */monthlyPayslips.add(monthlyPayslips1);
						/* 436: */}
					/* 437: */}
				/* 438:454 */if (payslip.getDeductionList() != null) {
					/* 439:455 */for (MonthlyPayslips monthlyPayslips2 : payslip
							.getDeductionList())
					/* 440: */{
						/* 441:456 */monthlyPayslips2.setAmount(Double
								.valueOf(monthlyPayslips2.getAmount()
										.doubleValue() * -1.0D));
		...
		/* 448:464 */mav.getModelMap().put("payrollcategormap",
				payrollCategoryMap);
