...
/* 15: */{
	/* 16:24 */private static final Logger logger = Logger
	...
	/* 19: */public String login(Model model, Users loginform, Locale locale,
	...
	/* 21: */{
		...
		/* 26:34 */if ((username != null) && (password != null)
				&& (!"".equals(username)) && (!"".equals(password)))
		/* 27: */{
			/* 28:39 */request.getSession().setAttribute("LOGGEDIN_USER",
					loginform);
			/* 29: */
			/* 30: */
			/* 31:42 */request.getSession().setAttribute("title",
