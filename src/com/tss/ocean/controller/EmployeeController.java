...
/* 42: */{
	/* 43: 51 */private static final Logger logger = LoggerFactory
	...
	/* 57: */{
		/* 58: 65 */this.employeesDAO = new HibernateDAOFactory()
				.getEmployeesDAO();
		/* 59: */}

	/* 60: */
	/* 61: */@RequestMapping(value = { "/addemployee.html" }, method = { org.springframework.web.bind.annotation.RequestMethod.POST })
	/* 62: */public ModelAndView addEmployee(
			@ModelAttribute Employees employee, Model model)
	/* 63: */{
		/* 64: 71 */logger.debug("addEmployee called :" + employee);
		/* 65: */
		/* 66: 73 */int status = ((Integer) this.employeesDAO.insert(employee))
				.intValue();
	...
	/* 73: */public ModelAndView employeeCategory(
	...
	/* 75: */{
		...
		/* 78: 85 */List<EmployeeCategory> employeeCategoryList = this.employeeCategoryDAO
				.getList();
		/* 79: */
		/* 80: 87 */mav.getModelMap().put("employeeCategoryList",
	...
	/* 91: */public ModelAndView add_employee_cat_get(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	/* 92: */throws Exception
	/* 93: */{
		...
		/* 100:107 */if (error != null) {
			...
			/* 102: */}
		/* 103:110 */mav.getModelMap()
				.put("employeecategory", employeeCategory);
		/* 104:111 */return mav;
		/* 105: */}

	/* 106: */
	/* 107: */@RequestMapping(value = { "/add_employee_category.html" }, method = { org.springframework.web.bind.annotation.RequestMethod.POST })
	/* 108: */public ModelAndView addEmployeeCategory(
			@ModelAttribute("employeecategory") @Valid EmployeeCategory employeeCategory,
	...
	/* 110: */{
		...
		/* 113: */{
			...
			/* 115:122 */int insertResult = ((Integer) this.employeeCategoryDAO
					.insert(employeeCategory)).intValue();
			/* 116:123 */if (insertResult > 0)
			/* 117: */{
				/* 118:124 */logger
						.info("Employee category Added Successfully with id "
								+ insertResult);
				/* 119:125 */return new ModelAndView(
						"redirect:add_employee_category.html").addObject(
						"success", Utilities.getSpringMessage(
								this.messageSource, "empcategory.add.success",
								locale));
				/* 120: */}
			/* 121:128 */logger.info("Error while inserting "
					+ employeeCategory);
			/* 122:129 */return new ModelAndView("add_employee_category", model)
					.addObject("error", Utilities
							.getSpringMessage(this.messageSource,
									"empcategory.add.error", locale));
			/* 123: */}
	...
	/* 128: */public ModelAndView editEmployeeCategoryget(
	...
	/* 130: */{
		...
		/* 132: */
		/* 133:145 */EmployeeCategory employeeCategory = (EmployeeCategory) this.employeeCategoryDAO
		...
		/* 136: */{
			...
			/* 138:148 */mav.getModelMap().put("employeecategory",
					employeeCategory);
			/* 139: */}
		/* 140: */else
		/* 141: */{
			/* 142:151 */mav = new ModelAndView(
					"redirect:employee_category.html");
			/* 143:152 */List<EmployeeCategory> employeeCategoryList = this.employeeCategoryDAO
					.getList();
			/* 144:153 */mav.getModelMap().put("employeeCategoryList",
					employeeCategoryList);
			/* 145: */}
	...
	/* 156: */public ModelAndView editEmployeeCategoryPost(
			@ModelAttribute("employeecategory") @Valid EmployeeCategory employeeCategory,
			BindingResult result, ModelMap model, Locale locale)
	...
	/* 158: */{
		...
		/* 161: */{
			/* 162:171 */int updateResult = this.employeeCategoryDAO
					.update(employeeCategory);
			/* 163:172 */if (updateResult > 0)
			/* 164: */{
				/* 165:173 */logger.info(
						"employee_category updated Successfully with id={0}",
						Integer.valueOf(updateResult));
				/* 166:174 */ModelAndView mav = new ModelAndView(
						"redirect:employee_category.html");
				/* 167:175 */List<EmployeeCategory> employeeCategoryList = this.employeeCategoryDAO
						.getList();
				/* 168:176 */mav.getModelMap().put("employeeCategoryList",
						employeeCategoryList);
				/* 169:177 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"empcategory.update.success", locale));
				/* 170: */}
			/* 171:180 */logger.warn(
					"Error occurred updating employee categry:{0}",
					employeeCategory);
			/* 172:181 */return new ModelAndView("edit_employee_category",
					model).addObject("error", Utilities.getSpringMessage(
					this.messageSource, "empcategory.update.error", locale));
			/* 173: */}
		/* 174:185 */logger.warn("Employee category values are not valid:",
				employeeCategory);
	...
	/* 179: */@ResponseBody
	/* 180: */public ModelAndView deleteEmployeeCategory(
			@RequestParam("id") int id, Locale locale)
	/* 181: */throws Exception
	/* 182: */{
		/* 183:193 */logger.info("delete_employee_category called.");
		/* 184:194 */EmployeeCategory employeeCategory = (EmployeeCategory) this.employeeCategoryDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 185:195 */ModelAndView mav = new ModelAndView(
				"redirect:employee_category.html");
		/* 186:196 */List<EmployeeCategory> employeeCategoryList = this.employeeCategoryDAO
				.getList();
		/* 187:197 */mav.getModelMap().put("employeeCategoryList",
				employeeCategoryList);
		/* 188:198 */if (employeeCategory != null)
		/* 189: */{
			/* 190:199 */int updateResult = this.employeeCategoryDAO
					.delete(employeeCategory);
			/* 191:201 */if (updateResult > 0)
			/* 192: */{
				/* 193:202 */logger.info(
						"Employee category with id {0} deleted successfully",
						employeeCategory.getId());
				/* 194: */
				/* 195:204 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"empcategory.delete.success", locale));
				/* 196: */}
			/* 197:207 */logger
					.warn("Error occurred while deleting employee category with id {0}",
							employeeCategory.getId());
			/* 198:208 */return mav.addObject("error", Utilities
					.getSpringMessage(this.messageSource,
							"empcategory.delete.error", locale));
			/* 199: */}
		/* 200:212 */logger.info(
				"Employee category with id {0} is already deleted",
				employeeCategory.getId());
		/* 201:213 */return mav.addObject("success", Utilities
				.getSpringMessage(this.messageSource,
						"empcategory.delete.success", locale));
		/* 202: */}
	...
	/* 205: */public ModelAndView employeeDepartment(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	...
	/* 207: */{
		...
		/* 210:223 */List<EmployeeDepartment> employeeDepartmentList = this.employeeDepartmentDAO
				.getList();
		/* 211: */
		/* 212:225 */mav.getModelMap().put("employeeDepartmentList",
	...
	/* 223: */public ModelAndView addEmployeeDeptGet(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	...
	/* 225: */{
		...
		/* 227:240 */ModelAndView mav = new ModelAndView(
		...
		/* 232:245 */if (error != null) {
			...
			/* 234: */}
		/* 235:248 */mav.getModelMap().put("employeedepartment",
				employeeDepartment);
		/* 236:249 */return mav;
		/* 237: */}
	...
	/* 240: */public ModelAndView addEmployeeDepartment(
			@ModelAttribute("employeedepartment") @Valid EmployeeDepartment employeeDepartment,
			BindingResult result, ModelMap model, Locale locale)
	...
	/* 242: */{
		...
		/* 245: */{
			/* 246:259 */int insertResult = ((Integer) this.employeeDepartmentDAO
					.insert(employeeDepartment)).intValue();
			/* 247:260 */if (insertResult > 0)
			/* 248: */{
				/* 249:261 */logger
						.info("Employee Department Added Successfully with id "
								+ insertResult);
				/* 250:262 */return new ModelAndView(
						"redirect:add_employee_department.html").addObject(
						"success", Utilities.getSpringMessage(
								this.messageSource,
								"empdepartment.add.success", locale));
				/* 251: */}
			/* 252:265 */logger.info("Error while inserting "
					+ employeeDepartment);
			/* 253:266 */return new ModelAndView("add_employee_department",
					model).addObject("error", Utilities.getSpringMessage(
					this.messageSource, "empdepartment.add.error", locale));
			/* 254: */}
	...
	/* 259: */public ModelAndView editEmployeeDepartmentGet(
			@RequestParam("id") int id, Locale locale,
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error)
	...
	/* 261: */{
		...
		/* 263: */
		/* 264:282 */EmployeeDepartment employeeDepartment = (EmployeeDepartment) this.employeeDepartmentDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 265: */ModelAndView mav;
		/* 266:283 */if (employeeDepartment != null)
		/* 267: */{
			/* 268:284 */mav = new ModelAndView("edit_employee_department");
			/* 269:285 */mav.getModelMap().put("employeedepartment",
					employeeDepartment);
			/* 270: */}
		/* 271: */else
		/* 272: */{
			/* 273:287 */mav = new ModelAndView(
					"redirect:employee_department.html");
			/* 274:288 */List<EmployeeDepartment> employeeDepartmentList = this.employeeDepartmentDAO
					.getList();
			/* 275:289 */mav.getModelMap().put("employeeDepartmentList",
					employeeDepartmentList);
			/* 276: */}
	...
	/* 287: */public ModelAndView editEmployeeDepartmentPost(
			@ModelAttribute("employeedepartment") @Valid EmployeeDepartment employeeDepartment,
			BindingResult result, ModelMap model, Locale locale)
	...
	/* 289: */{
		...
		/* 292: */{
			/* 293:307 */int updateResult = this.employeeDepartmentDAO
					.update(employeeDepartment);
			/* 294:308 */if (updateResult > 0)
			/* 295: */{
				/* 296:309 */logger.info(
						"employee_departmen updated Successfully with id={0}",
						Integer.valueOf(updateResult));
				/* 297:310 */ModelAndView mav = new ModelAndView(
						"redirect:employee_department.html");
				/* 298:311 */List<EmployeeDepartment> employeeDepartmentList = this.employeeDepartmentDAO
						.getList();
				/* 299:312 */mav.getModelMap().put("employeeDepartmentList",
						employeeDepartmentList);
				/* 300:313 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"empdepartment.update.success", locale));
				/* 301: */}
			/* 302:316 */logger.warn(
					"Error occurred updating employee Department:{0}",
					employeeDepartment);
			/* 303:317 */return new ModelAndView("edit_employee_department",
					model).addObject("error", Utilities.getSpringMessage(
					this.messageSource, "empdepartment.update.error", locale));
			/* 304: */}
		/* 305:321 */logger.warn("Employee department values are not valid:",
				employeeDepartment);
	...
	/* 310: */@ResponseBody
	/* 311: */public ModelAndView deleteEmployeeDepartment(
			@RequestParam("id") int id, Locale locale)
	/* 312: */throws Exception
	/* 313: */{
		/* 314:329 */logger.info("delete_employee_department called.");
		/* 315:330 */EmployeeDepartment employeeDepartment = (EmployeeDepartment) this.employeeDepartmentDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 316:331 */ModelAndView mav = new ModelAndView(
				"redirect:employee_department.html");
		/* 317:332 */List<EmployeeDepartment> employeeDepartmentList = this.employeeDepartmentDAO
				.getList();
		/* 318:333 */mav.getModelMap().put("employeeDepartmentList",
				employeeDepartmentList);
		/* 319:334 */if (employeeDepartment != null)
		/* 320: */{
			/* 321:335 */int updateResult = this.employeeDepartmentDAO
					.delete(employeeDepartment);
			/* 322:337 */if (updateResult > 0)
			/* 323: */{
				/* 324:338 */logger.info(
						"Employee department with id {0} deleted successfully",
						employeeDepartment.getId());
				/* 325: */
				/* 326:340 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"empdepartment.delete.success", locale));
				/* 327: */}
			/* 328:343 */logger
					.warn("Error occurred while deleting employee department with id {0}",
							employeeDepartment.getId());
			/* 329:344 */return mav.addObject("error", Utilities
					.getSpringMessage(this.messageSource,
							"empcategory.delete.error", locale));
			/* 330: */}
		/* 331:348 */logger.info(
				"Employee Department with id {0} is already deleted",
				employeeDepartment.getId());
		/* 332:349 */return mav.addObject("success", Utilities
				.getSpringMessage(this.messageSource,
						"empdepartment.delete.error", locale));
		/* 333: */}

	/* 334: */
	/* 335: */@RequestMapping(value = { "/employee.html" }, method = { org.springframework.web.bind.annotation.RequestMethod.GET })
	/* 336: */public ModelAndView getEmployyes(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	...
	/* 338: */{
		...
		/* 345:363 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
				.getList();
		/* 346:364 */for (EmployeeDepartment employeeDepartment : departmentList) {
			/* 347:365 */departmentMap.put(employeeDepartment.getId(),
					employeeDepartment.getDepartment());
			/* 348: */}
		/* 349:367 */mav.getModelMap().put("departmentmap", departmentMap);
		/* 350: */
		/* 351:369 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
				.getList();
		/* 352:370 */for (EmployeeCategory employeeCategory : categoryList) {
			/* 353:371 */categoryMap.put(employeeCategory.getId(),
	...
	/* 366: */public ModelAndView addEmployeeGet(
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error,
			Locale locale)
	...
	/* 368: */{
		...
		/* 379:397 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
				.getList();
		/* 380:398 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
				.getList();
		/* 381:399 */List<Bank> bankList = this.bankDAO.getList();
		/* 382:400 */mav.getModelMap().put("employee", employee);
		/* 383:401 */mav.getModelMap().put("employeeDepartmentList",
				departmentList);
		/* 384:402 */mav.getModelMap()
				.put("employeeCategoryList", categoryList);
	...
	/* 391: */public ModelAndView addEmployeePost(
			@ModelAttribute("employee") @Valid Employees employees,
			BindingResult result, ModelMap model, Locale locale)
	/* 392: */throws Exception
	/* 393: */{
		/* 394:413 */logger.info("add_employee Post called.");
		/* 395:414 */ModelAndView mav = new ModelAndView(
				"redirect:add_employee.html");
		/* 396:415 */
		...
		/* 397: */{
			...
			/* 399: */{
				/* 400:417 */employees.setPhotoData(Hibernate
						.createBlob(employees.getFileData().getInputStream()));
				/* 401:418 */employees.setPhotoFileName(employees.getFileData()
						.getOriginalFilename());
				/* 402:419 */employees.setPhotoContentType(employees
						.getFileData().getContentType());
				/* 403:420 */employees.setPhotoFileSize(Integer
						.valueOf(new Long(employees.getFileData().getSize())
								.intValue()));
				/* 404: */}
			/* 405:422 */int insertResult = ((Integer) this.employeesDAO
					.insert(employees)).intValue();
			/* 406:423 */
			System.out
					.println("HAAAAAAAAAAAAAAAAAASSSSSSSSSSSSSSSSNNNNNNNNNNNOOOOOOOOOOOEEEEEEEEERRRRRRRRRRRR"
							+ employees.toString());

			List<Employees> employeeList = this.employeesDAO.getList();
			/* 407:424 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
					.getList();
			/* 408:425 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
					.getList();
			/* 409:426 */List<Bank> bankList = this.bankDAO.getList();
			/* 410:427 */mav.getModelMap().put("employee", employees);
			/* 411:428 */mav.getModelMap().put("employeeDepartmentList",
					departmentList);
			/* 412:429 */mav.getModelMap().put("employeeCategoryList",
					categoryList);
			...
			/* 416: */{
				/* 417:433 */logger
						.info("Employee category Added Successfully with id "
								+ insertResult);
				/* 418:434 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"employee.add.success", locale));
				/* 419: */}
			/* 420:436 */logger.info("Error while inserting " + employees);
			/* 421:437 */return mav.addObject("error", Utilities
					.getSpringMessage(this.messageSource, "employee.add.error",
							locale));
			/* 422: */}
	...
	/* 427: */public ModelAndView editEmployeeGet(@RequestParam("id") int id,
			Locale locale,
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error)
	...
	/* 429: */{
		...
		/* 431: */
		/* 432:452 */Employees employees = (Employees) this.employeesDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		...
		/* 435: */{
			...
			/* 438:456 */List<Employees> employeeList = this.employeesDAO
					.getList();
			/* 439:457 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
					.getList();
			/* 440:458 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
					.getList();
			/* 441:459 */List<Bank> bankList = this.bankDAO.getList();
			/* 442:460 */mav.getModelMap().put("employeeDepartmentList",
					departmentList);
			/* 443:461 */mav.getModelMap().put("employeeCategoryList",
					categoryList);
		...
		/* 448: */{
			...
			/* 450:467 */List<Employees> employeeList = this.employeesDAO
					.getList();
			...
			/* 454:471 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
					.getList();
			/* 455:472 */for (EmployeeDepartment employeeDepartment : departmentList) {
				/* 456:473 */departmentMap.put(employeeDepartment.getId(),
						employeeDepartment.getDepartment());
				/* 457: */}
			/* 458:475 */mav.getModelMap().put("departmentmap", departmentMap);
			/* 459: */
			/* 460:477 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
					.getList();
			/* 461:478 */for (EmployeeCategory employeeCategory : categoryList) {
				/* 462:479 */categoryMap.put(employeeCategory.getId(),
						employeeCategory.getCategory());
				/* 463: */}
	...
	/* 476: */public ModelAndView editEmployeePost(
			@ModelAttribute("employee") @Valid Employees employees,
			BindingResult result, ModelMap model, Locale locale)
	/* 477: */throws Exception
	/* 478: */{
		/* 479:497 */logger.info("edit_employee-post called.");
		/* 480:498 */ModelAndView mav = new ModelAndView(
		...
		System.out.println("____________RRRRRRRRR_____________"
				+ employees.getPassportExpiryDate());

		if (!result.hasErrors())
		/* 482: */{
			/* 483:500 */if (employees.getFileData() != null)
			/* 484: */{
				/* 485:501 */employees.setPhotoData(Hibernate
						.createBlob(employees.getFileData().getInputStream()));
				/* 486:502 */employees.setPhotoFileName(employees.getFileData()
						.getOriginalFilename());
				/* 487:503 */employees.setPhotoContentType(employees
						.getFileData().getContentType());
				/* 488:504 */employees.setPhotoFileSize(Integer
						.valueOf(new Long(employees.getFileData().getSize())
								.intValue()));
				/* 489: */}
			/* 490:506 */int updateResult = this.employeesDAO.update(employees);
			/* 491:507 */List<Employees> employeeList = this.employeesDAO
					.getList();
			...
			/* 495:511 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
					.getList();
			/* 496:512 */for (EmployeeDepartment employeeDepartment : departmentList) {
				/* 497:513 */departmentMap.put(employeeDepartment.getId(),
						employeeDepartment.getDepartment());
				/* 498: */}
			/* 499:515 */mav.getModelMap().put("departmentmap", departmentMap);
			/* 500: */
			/* 501:517 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
					.getList();
			/* 502:518 */for (EmployeeCategory employeeCategory : categoryList) {
				/* 503:519 */categoryMap.put(employeeCategory.getId(),
						employeeCategory.getCategory());
				/* 504: */}
			...
			/* 507: */{
				/* 508:523 */logger.info(
						"employee  updated Successfully with id={0}",
						Integer.valueOf(updateResult));
				/* 509: */
				/* 510:525 */List<EmployeeCategory> employeeCategoryList = this.employeeCategoryDAO
						.getList();
				/* 511:526 */mav.getModelMap().put("employeeCategoryList",
						employeeCategoryList);
				/* 512:527 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"employee.update.success", locale));
				/* 513: */}
			/* 514:530 */logger.warn(
					"Error occurred updating employee categry:{0}", employees);
			/* 515:531 */

			/*
			 * return new ModelAndView("edit_employee",
			 * model).addObject("error",
			 * Utilities.getSpringMessage(this.messageSource,
			 * "employee.update.error", locale));
			 *//* 516: */}
		/* 517:535 */logger.warn("Employee  values are not valid:", employees);
		/* 518:536 */List<Employees> employeeList = this.employeesDAO.getList();
		/* 519:537 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
				.getList();
		/* 520:538 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
				.getList();
		/* 521:539 */List<Bank> bankList = this.bankDAO.getList();
		/* 522:540 */mav.getModelMap().put("employeeDepartmentList",
				departmentList);
		/* 523:541 */mav.getModelMap()
				.put("employeeCategoryList", categoryList);
	...
	/* 530: */@ResponseBody
	/* 531: */public byte[] getImage(@RequestParam("id") int id, Locale locale,
			@RequestParam(value = "success", required = false) String success,
			@RequestParam(value = "error", required = false) String error)
	/* 532: */throws SQLException
	/* 533: */{
		/* 534:555 */logger.info("emoloyeeimage called.");
		/* 535:556 */Employees employees = (Employees) this.employeesDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 536:558 */if (employees.getPhotoData() != null)
		/* 537: */{
			/* 538:559 */int blobLength = (int) employees.getPhotoData()
					.length();
			/* 539:560 */byte[] blobAsBytes = employees.getPhotoData()
					.getBytes(1L, blobLength);
	...
	/* 546: */@ResponseBody
	/* 547: */public ModelAndView deleteEmployee(@RequestParam("id") int id,
			Locale locale)
	/* 548: */throws Exception
	/* 549: */{
		/* 550:570 */logger.info("delete_employee called.");
		/* 551:571 */Employees employees = (Employees) this.employeesDAO
				.getRecordByPrimaryKey(Integer.valueOf(id));
		/* 552:572 */ModelAndView mav = new ModelAndView(
				"redirect:employee.html");
		...
		/* 557:577 */List<EmployeeDepartment> departmentList = this.employeeDepartmentDAO
				.getList();
		/* 558:578 */for (EmployeeDepartment employeeDepartment : departmentList) {
			/* 559:579 */departmentMap.put(employeeDepartment.getId(),
					employeeDepartment.getDepartment());
			/* 560: */}
		/* 561:581 */mav.getModelMap().put("departmentmap", departmentMap);
		/* 562: */
		/* 563:583 */List<EmployeeCategory> categoryList = this.employeeCategoryDAO
				.getList();
		/* 564:584 */for (EmployeeCategory employeeCategory : categoryList) {
			/* 565:585 */categoryMap.put(employeeCategory.getId(),
					employeeCategory.getCategory());
			/* 566: */}
		...
		/* 569: */{
			...
			/* 572: */{
				/* 573:592 */logger.info(
						"Employee  with id {0} deleted successfully",
						employees.getId());
				/* 574: */
				/* 575:594 */return mav.addObject("success", Utilities
						.getSpringMessage(this.messageSource,
								"employee.delete.success", locale));
				/* 576: */}
			/* 577:597 */logger.warn(
					"Error occurred while deleting employee  with id {0}",
					employees.getId());
			/* 578:598 */return mav.addObject("error", Utilities
					.getSpringMessage(this.messageSource,
							"employee.delete.error", locale));
			/* 579: */}
		/* 580:602 */logger.info(
				"Employee Department with id {0} is already deleted",
				employees.getId());
		/* 581:603 */return mav.addObject("success", Utilities
				.getSpringMessage(this.messageSource, "employee.delete.error",
						locale));
		/* 582: */}
	...
	/* 587: */{
		...
		/* 591: */
		/* 592:615 */List<PurordApprovers> approvers = this.purchaseApproversDAO
				.getListByCondition("t order by t.level");
		/* 593:616 */if (approvers != null)
		/* 594: */{
			/* 595:617 */Iterator<PurordApprovers> iterate = approvers
					.iterator();
			/* 596:618 */while (iterate.hasNext())
			/* 597: */{
				/* 598:619 */PurordApprovers purordApprovers = (PurordApprovers) iterate
						.next();
				/* 599:620 */Employees emp = (Employees) this.employeesDAO
						.getRecordByPrimaryKey(Integer.valueOf(purordApprovers
								.getUserid()));
				/* 600:621 */empselected.add(emp);
				/* 601:622 */empList.remove(emp);
				/* 602: */}
			/* 603: */}
		/* 604:626 */logger.debug("get add-approver :" + empList.size() + ":"
				+ empselected.size());
	...
	/* 616: */public String add_approverPost(
			@RequestParam("users") int[] users, Map<String, Object> model)
	...
	/* 618: */{
		...
		/* 622: */
		/* 623:644 */List<PurordApprovers> approvers = this.purchaseApproversDAO
				.getListByCondition("t order by t.level");
		/* 624:645 */if (approvers != null)
		/* 625: */{
			/* 626:646 */Iterator<PurordApprovers> iterate = approvers
					.iterator();
			/* 627:647 */while (iterate.hasNext())
			/* 628: */{
				/* 629:648 */PurordApprovers purordApprovers = (PurordApprovers) iterate
						.next();
				/* 630:649 */Employees emp = (Employees) this.employeesDAO
						.getRecordByPrimaryKey(Integer.valueOf(purordApprovers
								.getUserid()));
