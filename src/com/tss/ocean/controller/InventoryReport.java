...
public class InventoryReport {
	...
	/* 30: 42 */private static final Logger logger = Logger
			.getLogger(InventoryReport.class.getName());
...

	{
		...
		List l = itemDAO.getListByHQLQuery("from Item i where  i.name like '%"
				+ query + "%'");
	...
	public ModelAndView itemByCatagory(@RequestParam("category") String catagory) {
		...
		List l = itemDAO
				.getListByHQLQuery("from Item i where  i.categoryid.name like '%"
						+ catagory + "%'");
	...
	public ModelAndView itemByStock(@RequestParam("stock") int stock,
