...
/* 45: */{
	/* 46: 53 */private static final Logger LOG = LoggerFactory
			.getLogger(PurrequisitionController.class);
	/* 47: */@Autowired
		...
		/* 68: 81 */binder.registerCustomEditor(Set.class,
				...
				/* 69: */{
					...
					/* 71: */{
						...
						/* 73: 85 */return PurrequisitionController.this.itemDAO
	...
	/*
	 * 79: @PreAuthorize(
	 * "hasAnyRole('ROLE_USER') AND hasPermission('purchaserequisition','add')")
	 *//* 80: */
		...
		/* 106: */{
			...
			/* 142: */{
				...
				/* 145:155 */return new ModelAndView(
						"redirect:edit-purchase_requisition.html?id="
			...
			/* 151:162 */return new ModelAndView("purchase_requisition", model)
					.addObject("error", Utilities.getSpringMessage(
							this.messageSource, "purrequisition.add.error",
							locale));
			/* 152: */}
		/* 153:167 */LOG.debug("Purchase_requisition values are not valid:",
				purrequisition.toString());
	...
	/*
	 * @PreAuthorize(
	 * "hasAnyRole('ROLE_USER') AND hasPermission('purchaserequisition','view')"
	 * )
	...
	/*
	 * 257: @PreAuthorize(
	 * "hasAnyRole('ROLE_USER') AND hasPermission('purchaserequisition','delete')"
	 * )
	 *//* 258: */public boolean delete_purrequisition(
