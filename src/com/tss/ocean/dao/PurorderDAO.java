...
/* 20: */{
	/* 21:17 */static final Logger LOG = LoggerFactory
			.getLogger(GenericDAOImpl.class);

	/* 22: */
	/* 23: */public List<Purorder> getPurOrderList_dateRange(Date fromDate,
			Date toDate)
	/* 24: */{
		...
		/* 28: */{
			/* 29:24 */lst = session
					.createQuery(
							"from Purorder p where p.createdat >= :fromDate and p.createdat < :toDate")
					.setParameter("fromDate", fromDate)
					.setParameter("toDate", toDate).list();
			/* 30:25 */System.out.println("List Size ********************** "
					+ lst.size());
			/* 31: */}
		...
		/* 33: */{
			/* 34:27 */lst = null;
			/* 35:28 */LOG.error(
					" [PurorderDAO] Exception in getPurOrderList_dateRange Method:"
							+ e, e);
			/* 36: */}
		/* 37: */finally
		/* 38: */{
