...
/* 12: */{
	/* 13:20 */private static final Logger logger = Logger
	...
	/* 17: */{
		/* 18:24 */logger.log(
				Level.OFF,
				"Interceptor: Pre-handle{0}:{1}",
				new Object[] { request.getRequestURI(),
						request.getContextPath() });
		/* 19:25 */if ((!request.getRequestURI().equals(
				request.getContextPath()))
		...
		/* 20: */{
			...
			/* 22:27 */if (!allow)
			/* 23: */{
				/* 24:28 */response.sendRedirect(request.getContextPath()
						+ "/login.html");
				/* 25:29 */return false;
				/* 26: */}
			/* 27: */}
	...
	/* 30: */
	/* 31: */public void postHandle(HttpServletRequest hsr,
			HttpServletResponse hsr1, Object o, ModelAndView mav)
	/* 32: */throws Exception
	/* 33: */{
	...
	/* 36: */
	/* 37: */public void afterCompletion(HttpServletRequest hsr,
