...
/* 8: */{
	...
	/* 16: */
	/* 17: */public ACLEntity(Integer Id, String aclId, Integer entityId,
			Integer entityType, Integer permissionlevel)
	/* 18: */{
		/* 19: 28 */this.Id = Id;
	...
	/* 77: */{
		/* 78: 77 */return "ACLEntity{Id=" + this.Id + ", aclId=" + this.aclId
				+ ", entityId=" + this.entityId + ", entityType="
				+ this.entityType + ", permissionlevel=" + this.permissionLevel
				+ '}';
		/* 79: */}
	...
	/* 93: */{
		...
		/* 110:109 */if (!Objects.equals(this.entityType, other.entityType)) {
			...
			/* 112: */}
		/* 113:112 */if (!Objects.equals(this.permissionLevel,
