...
/* 12: */{
	...
	/* 65: */
	/* 66: */public Accounts(String name, Integer type, String address,
			String address2, String postal, String city, String state,
			String country, String firstname, String lastname, String email,
			String phone, String phone2, String fax, String notes,
			Boolean visible, BigDecimal maxdebt, BigDecimal curdebt,
			byte[] image)
	/* 67: */{
