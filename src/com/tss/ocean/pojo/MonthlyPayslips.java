...
/* 9: */{
	...
	/* 31: */
	/* 32: */public MonthlyPayslips(Date salaryDate, Integer employeeId,
			Integer payrollCategoryId, Double amount, boolean isApproved,
			Integer approverId, boolean isRejected, Integer rejectorId,
	...
	/* 157: */{
		/* 158:137 */return "MonthlyPayslips{id=" + this.id + ", salaryDate="
				+ this.salaryDate + ", employeeId=" + this.employeeId
				+ ", payrollCategoryId=" + this.payrollCategoryId + ", amount="
				+ this.amount + ", isApproved=" + this.isApproved
				+ ", approverId=" + this.approverId + ", isRejected="
				+ this.isRejected + ", rejectorId=" + this.rejectorId
				+ ", reason=" + this.reason + ", remark=" + this.remark + '}';
		/* 159: */}
	/* 160: */
}
