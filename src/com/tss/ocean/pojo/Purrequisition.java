...
/* 15: */{
	...
	/* 42: */
	/* 43: */public Purrequisition(String prno, Integer suplierid,
			Integer status, Integer approvedby, Date approvedbydate,
			Integer nextapprovedby, Date createdat, Date updatedat,
			Boolean isbilled, BigDecimal price, Integer createdby,
			Integer updatedby, Set<Item> items)
	/* 44: */{
	...
	/* 201: */{
		/* 202:175 */return "Purrequisition{id=" + this.id + ", prno="
				+ this.prno + ", suplierid=" + this.suplierid + ", status="
				+ this.status + ", approvedby=" + this.approvedby
				+ ", approvedbydate=" + this.approvedbydate
				+ ", nextapprovedby=" + this.nextapprovedby + ", createdat="
				+ this.createdat + ", updatedat=" + this.updatedat
				+ ", isbilled=" + this.isbilled + ", price=" + this.price
				+ ", createdby=" + this.createdby + ", updatedby="
				+ this.updatedby + ", items=" + this.items + '}';
		/* 203: */}
	...
	/* 209: */
	/* 210: */public void setPurrequisitiondts(
			List<Purrequisitiondt> purrequisitiondts)
	/* 211: */{
