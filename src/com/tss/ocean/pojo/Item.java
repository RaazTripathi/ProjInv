...
/* 12: */{
	...
	/* 81: */
	/* 82: */public Item(String name, String alias, int categoryid,
			Itemtype typeid, BigDecimal price, String barcode, int taxid,
			Itemunit unitid, int currstock)
	/* 83: */{
	...
	/* 184: */public String toString() {
		return "Item{id=" + this.id + ", name=" + this.name + ", alias="
				+ this.alias + ", categoryid=" + this.categoryid + ", typeid="
				+ this.typeid + ", price=" + this.price + ", barcode="
				+ this.barcode + ", taxid=" + this.taxid + ", currstock="
