...
/* 14: */{
	...
	/* 20: */
	/* 21: */public JqGridData(String sEcho, int iTotalDisplayRecords,
			int iTotalRecords, List rows)
	/* 22: */{
	...
	/* 30: */{
		...
		/* 36:75 */map
				.put("iTotalRecords", Integer.valueOf(this.iTotalRecords));
		/* 37:76 */map.put("iTotalDisplayRecords",
				Integer.valueOf(this.iTotalDisplayRecords));
		...
		/* 45: */{
			/* 46:82 */Logger.getLogger(JqGridData.class.getName()).log(
					Level.SEVERE, null, ex);
			/* 47: */}
		/* 48: */catch (JsonMappingException ex)
		/* 49: */{
			/* 50:84 */Logger.getLogger(JqGridData.class.getName()).log(
					Level.SEVERE, null, ex);
			/* 51: */}
		/* 52: */catch (IOException ex)
		/* 53: */{
			/* 54:86 */Logger.getLogger(JqGridData.class.getName()).log(
					Level.SEVERE, null, ex);
			/* 55: */}
		/* 56:89 */return json;
		/* 57: */}
