...
public abstract interface GenericDAO<DomainObject extends Serializable, KeyType extends Serializable> {
	...
	public abstract DomainObject getRecordByKeyandValue(String paramString,
			Object paramObject);

	public abstract List getRecordListByKeyandValue(String paramString,
			Object paramObject);

	public abstract List<DomainObject> getListByKeyandValue(String paramString,
	...
	public abstract List getListByPage(String paramString, int paramInt1,
			int paramInt2);

	public abstract String getJsonPageData(int paramInt1, int paramInt2,
			String paramString1, String paramString2);

	public abstract List<DomainObject> getListByPage(String paramString1,
			String paramString2, int paramInt1, int paramInt2);

	public abstract String getJson(int paramInt1, int paramInt2,
			String paramString1, String paramString2,
			List<DomainObject> paramList);
